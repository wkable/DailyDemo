...
public final class PackageParserCompat {
    ...
    public static PackageParser.Package parsePackage(final Context context, final File apk, final int flags) {
        try {
    ...
    private static final class PackageParserPPreview {
        ...
        static PackageParser.Package parsePackage(Context context, File apk, int flags) throws Throwable {
    ...
    private static final class PackageParserLollipop {
        ...
        static PackageParser.Package parsePackage(final Context context, final File apk, final int flags) throws Throwable {
            PackageParser parser = new PackageParser();
            PackageParser.Package pkg = parser.parsePackage(apk, flags);
